...
const std::map<std::string, HttpRequestMethod> HttpMaps::httpRequestMethodMap = initHttpRequestMethodMap();

const std::map<std::string, HttpRequestVersion> HttpMaps::httpRequestVersionMap = initHttpRequestVersionMap();

const std::set<std::string> HttpMaps::headerSet = initHeaderSet();
const std::set<std::string> HttpMaps::requiredHeaders1_1 = initRequiredHeaders1_1();
...
std::map<std::string, HttpRequestVersion> HttpMaps::initHttpRequestVersionMap() {
