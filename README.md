...
- 🛡️ **Resilient**: Built to handle stress tests and high traffic without crashing.
- ⚡ **Efficient**: Implements non-blocking I/O using `poll()` for scalable performance.
- 🛠️ **Flexible**: Supports multiple ports, virtual hosts, and customizable configurations.
...
💡 In essence, **Webserv** provides a simplified yet powerful approach to understanding and replicating the core functionalities of a web server like **NGINX**.
